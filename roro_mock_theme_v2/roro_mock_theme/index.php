...
<header>
    <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/logo_roro.png" alt="Project RORO ロゴ" class="logo" />
</header>
<main>
    <!-- 挨拶文と言語切替ボタンを横並びで配置 -->
    <div class="login-header">
        ...
        <button id="lang-toggle-btn" class="lang-toggle" title="Change language">
            <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/icon_language.png" alt="Language" />
        </button>
    </div>
    <!-- ログインフォーム -->
